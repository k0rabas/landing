...
DEBUG = False   # will be overrided by .production an than by .local if it exists


ALLOWED_HOSTS = []  # will be overrided by .production an than by .local if it exists
...
ADMIN_SITE_HEADER = "landing administration"
